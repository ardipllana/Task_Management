...
/****** Object:  Database [Task_Management]    Script Date: 5/13/2019 8:25:07 PM ******/
CREATE DATABASE [Task_Management]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Task_Management', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\DATA\Task_Management.mdf' , SIZE = 3136KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'Task_Management_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\DATA\Task_Management_log.ldf' , SIZE = 832KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [Task_Management] SET COMPATIBILITY_LEVEL = 110
GO
...
ALTER DATABASE [Task_Management] SET AUTO_CLOSE ON 
GO

ALTER DATABASE [Task_Management] SET AUTO_CREATE_STATISTICS ON 
GO
...
ALTER DATABASE [Task_Management] SET RECOVERY SIMPLE 
GO
...
ALTER DATABASE [Task_Management] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
